...
val viewModule = module {
    ...
    viewModel { RQDMVSplashVM(onboardingRepository = get()) }

    viewModel { RQDMVOnboardingVM(onboardingRepository = get()) }

    viewModel { ProductViewModel(productRepository = get(), cartRepository = get()) }

    viewModel { ProductDetailsViewModel(productRepository = get(), cartRepository = get()) }
